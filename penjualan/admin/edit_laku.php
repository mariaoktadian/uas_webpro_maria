...
<?php
// QUERY UNTUK GET ID ENTRY PENJUALAN YG AKAN DI UPDATE
$id_brg=mysql_real_escape_string($_GET['id']);
// END QUERY GET


// QUERY SELECT UNTUK MENAMPILKAN DATA ENTRY PENJUALAN YG AKAN DI UPDATE
...
<!-- DATE PICKER JS UNTUK INPUT TEXT TGL -->
